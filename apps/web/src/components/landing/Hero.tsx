    ...
    <section id="hero" ref={ref} className="relative min-h-screen flex flex-col justify-center overflow-hidden" data-testid="hero-section">
      ...
      <motion.div style={{ y: textY, opacity }} className="relative max-w-7xl mx-auto px-6 w-full pt-32 pb-20">
        ...
        <motion.p
          ...
          className="font-script text-upPink text-4xl lg:text-6xl mb-4 rotate-[-2deg] origin-left drop-shadow-[0_0_20px_rgba(255,83,104,0.4)]"
        >
        ...
        <h1 className="font-display font-bold tracking-tight leading-[0.95]">
          ...
          >
            NÍVEL
            <motion.span
              initial={{ opacity: 0, scale: 0, y: 30, x: -30 }}
              animate={{ opacity: 1, scale: 1, y: 0, x: 0 }}
              transition={{ duration: 0.8, delay: 2.8, ease: "backOut" }}
              className="inline-flex items-center justify-center ml-4 align-middle"
            >
              <Rocket className="w-12 h-12 sm:w-16 sm:h-16 lg:w-24 lg:h-24 text-upPink rotate-75 drop-shadow-[0_0_25px_rgba(255,83,104,0.8)] animate-pulse" />
            </motion.span>
          </motion.span>
        </h1>
        ...
        <div className="mt-12 grid lg:grid-cols-2 gap-10 items-end">
          ...
          >
            Análise de métricas do Instagram, gerador de conteúdo e uma
      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-4 sm:py-5 grid grid-cols-2 gap-x-4 gap-y-2 sm:flex sm:flex-wrap sm:items-center sm:justify-between sm:gap-6">
          {[
            ["Instagram", "métricas em tempo real"],
