...
export default function StudentCoursePlayerPage() {
  ...
  // Anotações pessoais vinculadas ao Timestamp
  ...
  const toggleLessonCompletion = (lessonId: string) => {
    ...
    // Se concluiu todas as aulas, abre o Certificado
  ...
  return (
    <div className="min-h-screen bg-[#08080c] text-upLightGray antialiased">
        ...
        <div className="max-w-7xl mx-auto px-4 h-14 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <span className="hidden sm:inline">Voltar para Trilha</span>
            </Link>
          ...
          <div className="flex items-center gap-3">
            {/* Certificado Button se Concluído */}
            <button
      ...
      {/* Conteúdo Principal Dual-Pane: Player na esquerda/centro, Grade do Curso na direita */}
      <div className="max-w-7xl mx-auto p-4 sm:p-6 grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          {/* BARRA DE AÇÕES DA AULA (Concluir Aula, XP, Controles de Velocidade) */}
          ...
          {/* ABAS DE ESTUDO (Visão Geral, Prompts IA, Materiais PDF, Anotações, Comentários) */}
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-upDark border border-upPink/30 rounded-2xl">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <button
                        onClick={() => handleCopyPrompt("Atue como um estrategista de conteúdo para Instagram no nicho de marketing...")}
      ...
      {/* Modal de Certificado ao Concluir o Curso */}
      <CertificateModal
