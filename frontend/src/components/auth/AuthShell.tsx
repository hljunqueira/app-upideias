  ...
  return (
    <div className="bg-upBlack min-h-screen flex">
      ...
      <div className="hidden lg:flex relative w-[44%] overflow-hidden flex-col justify-between p-12">
        ...
        <Link href="/" className="relative flex items-center gap-2.5 group w-max" data-testid="auth-logo-home">
          <img src="/UP-Logo-removebg-preview.png" alt="UP Ideias" className="h-11 w-auto transition-transform duration-300 group-hover:-rotate-6" />
        ...
        <div className="relative">
          ...
          <div className="mt-10 flex flex-wrap gap-x-8 gap-y-3">
            {[["+2,3x", "alcance com IA"], ["6+ trilhas", "no UP Creator"], ["7 dias", "grátis"]].map(([v, l]) => (
