...
const features = [
  { icon: BrainCircuit, title: "Diagnóstico estratégico com IA", desc: "A IA analisa 30 dias de métricas e entrega o que melhorou, o que piorou e o que fazer agora." },
        ...
        <div>
          ...
          <div className="mt-12 space-y-8">
            {features.map((f, i) => (
              ...
              >
                <div className="shrink-0 w-12 h-12 rounded-2xl bg-upCard border border-upBorder flex items-center justify-center group-hover:border-upPink/60 group-hover:shadow-[0_0_20px_rgba(255,83,104,0.25)] transition-all duration-300">
                  <f.icon className="w-5 h-5 text-upPink" />
                </div>
                <div>
        ...
        <div style={{ perspective: 1200 }}>
          ...
          >
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="text-xs bg-upPink/15 text-upPink border border-upPink/30 rounded-full px-3 py-1">IA ativa</span>
            </div>
            ...
            >
              <p className="text-[11px] uppercase tracking-wider text-upPink font-semibold">Diagnóstico IA</p>
