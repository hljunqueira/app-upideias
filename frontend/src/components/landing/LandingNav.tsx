    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 h-[72px] flex items-center justify-between">
        <a href="#hero" className="flex items-center gap-2.5 group" data-testid="nav-logo">
          <img src="/UP-Logo-removebg-preview.png" alt="UP Ideias" className="h-11 w-auto object-contain transition-transform duration-300 group-hover:-rotate-6" />
          <span className="font-display text-lg font-bold tracking-tight text-white">
            UP <span className="text-upPink">IDEIAS</span>
          </span>
        </a>
        <nav className="hidden md:flex items-center gap-9">
          {links.map((l) => (
            <a
              ...
              className="text-sm text-upGray hover:text-white transition-colors duration-300 relative after:absolute after:-bottom-1 after:left-0 after:h-px after:w-0 after:bg-upPink after:transition-all after:duration-300 hover:after:w-full"
            >
              {l.label}
            </a>
          ))}
