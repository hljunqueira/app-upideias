...
export default function Register() {
  ...
  return (
    <AuthShell script="comece grátis hoje —" headline={"CRIE SUA\nCONTA UP."}>
      ...
      <h2 className="font-display text-3xl font-bold text-white">Criar conta gratuita</h2>
      <p className="text-sm text-upGray mt-2">7 dias grátis em qualquer plano · sem cartão</p>

      {error && (
        <div data-testid="register-error" className="mt-6 px-4 py-3 bg-upPink/10 border border-upPink/30 rounded-xl text-xs text-upPink font-semibold">
          {error}
        </div>
      )}
